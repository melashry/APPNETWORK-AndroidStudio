...
public class ShowWebView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    // INTERNAL SPLASHSCREEN --- Define url that will open in webview	
		String webViewUrl = "file:///android_asset/index.html";
		
		//EXTERNAL Page ---Define url that will open in webview
		// String webViewUrl = "http://YOURSITE.com";
	           ...
	           /**updated, out of the IF **/
	            ...
	            try{	
	               ...
	               // captureIntent.putExtra(MediaStore.EXTRA_SCREEN_ORIENTATION, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
	                ...
	                Intent chooserIntent = Intent.createChooser(i, "File");
	                chooserIntent.putExtra(Intent.EXTRA_INITIAL_INTENTS, new Parcelable[] { captureIntent });

	                startActivityForResult(chooserIntent, FILECHOOSER_RESULTCODE);
	              }
	             catch(Exception e){
	            	 Toast.makeText(getBaseContext(), "Camera:"+e, Toast.LENGTH_LONG).show();
	             }
	            //}
	        }
